  ...
  15:	83 39 02             	cmpl   $0x2,(%ecx)
{
  ...
  3e:	e8 10 03 00 00       	call   353 <faps>
    exit();
...
00000353 <faps>:
SYSCALL(faps)
 353:	b8 2a 00 00 00       	mov    $0x2a,%eax
 358:	cd 40                	int    $0x40
 35a:	c3                   	ret    
...
free(void *ap)
{
 ...
 5f5:	a1 4c 0a 00 00       	mov    0xa4c,%eax
{
...
malloc(uint nbytes)
{
 ...
 68d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 690:	8b 3d 4c 0a 00 00    	mov    0xa4c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 702:	e8 e9 fe ff ff       	call   5f0 <free>
  return freep;
 707:	a1 4c 0a 00 00       	mov    0xa4c,%eax
 ...
 734:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 737:	a3 4c 0a 00 00       	mov    %eax,0xa4c
}
