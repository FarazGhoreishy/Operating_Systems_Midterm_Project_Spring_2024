...
int main() 
{
  ...
  2b:	68 29 08 00 00       	push   $0x829
  30:	6a 01                	push   $0x1
  32:	e8 79 04 00 00       	call   4b0 <printf>
  ...
  74:	83 05 10 0b 00 00 01 	addl   $0x1,0xb10
            faps(getpid());
 ...
 40c:	89 d1                	mov    %edx,%ecx
{
 ...
 439:	0f b6 92 34 08 00 00 	movzbl 0x834(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 634:	eb 1a                	jmp    650 <printf+0x1a0>
          s = "(null)";
 636:	bb 2b 08 00 00       	mov    $0x82b,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 685:	a1 14 0b 00 00       	mov    0xb14,%eax
{
 ...
 6a6:	73 10                	jae    6b8 <free+0x38>
{
 ...
 6d1:	5b                   	pop    %ebx
  freep = p;
 6d2:	a3 14 0b 00 00       	mov    %eax,0xb14
}
 6d7:	5e                   	pop    %esi
 6d8:	5f                   	pop    %edi
 6d9:	5d                   	pop    %ebp
...
malloc(uint nbytes)
{
 ...
 71d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 720:	8b 3d 14 0b 00 00    	mov    0xb14,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 769:	8b 3d 14 0b 00 00    	mov    0xb14,%edi
 ...
 792:	e8 e9 fe ff ff       	call   680 <free>
  return freep;
 797:	a1 14 0b 00 00       	mov    0xb14,%eax
 ...
 7de:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 7e0:	c7 05 14 0b 00 00 18 	movl   $0xb18,0xb14
 7e7:	0b 00 00 
    base.s.size = 0;
 7ea:	bf 18 0b 00 00       	mov    $0xb18,%edi
    base.s.ptr = freep = prevp = &base;
 7ef:	c7 05 18 0b 00 00 18 	movl   $0xb18,0xb18
 7f6:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
