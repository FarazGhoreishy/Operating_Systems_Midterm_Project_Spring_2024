...
801003c4:	e8 e7 02 00 00       	call   801006b0 <cprintf>
  cprintf("\n");
801003c9:	c7 04 24 6b 7e 10 80 	movl   $0x80107e6b,(%esp)
...
80102020:	68 52 7c 10 80       	push   $0x80107c52
...
80103002:	e8 29 2b 00 00       	call   80105b30 <idtinit>
...
8010308d:	e8 1e 08 00 00       	call   801038b0 <pinit>
  tvinit();        // trap vectors
80103092:	e8 19 2a 00 00       	call   80105ab0 <tvinit>
  binit();         // buffer cache
...
801037dc:	89 15 04 a0 10 80    	mov    %edx,0x8010a004
  release(&ptable.lock);
801037e2:	e8 19 10 00 00       	call   80104800 <release>
...
80103804:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103807:	c7 40 14 9f 5a 10 80 	movl   $0x80105a9f,0x14(%eax)
  p->context = (struct context*)sp;
...
80103816:	e8 35 10 00 00       	call   80104850 <memset>
...
8010383a:	e8 c1 0f 00 00       	call   80104800 <release>
}
...
8010386f:	e8 8c 0f 00 00       	call   80104800 <release>
...
801038ba:	68 40 78 10 80       	push   $0x80107840
801038bf:	68 20 2d 11 80       	push   $0x80112d20
801038c4:	e8 f7 0c 00 00       	call   801045c0 <initlock>
}
...
80103968:	83 ec 04             	sub    $0x4,%esp
  pushcli();
8010396b:	e8 d0 0c 00 00       	call   80104640 <pushcli>
  c = mycpu();
80103970:	e8 5b ff ff ff       	call   801038d0 <mycpu>
  p = c->proc;
80103975:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
8010397b:	e8 10 0d 00 00       	call   80104690 <popcli>
}
...
801039a7:	e8 b4 36 00 00       	call   80107060 <setupkvm>
...
801039c5:	e8 66 33 00 00       	call   80106d30 <inituvm>
...
801039da:	e8 71 0e 00 00       	call   80104850 <memset>
...
80103a33:	68 70 78 10 80       	push   $0x80107870
80103a38:	50                   	push   %eax
80103a39:	e8 d2 0f 00 00       	call   80104a10 <safestrcpy>
  p->cwd = namei("/");
80103a3e:	c7 04 24 79 78 10 80 	movl   $0x80107879,(%esp)
...
80103a77:	68 57 78 10 80       	push   $0x80107857
...
80103a99:	8b 75 08             	mov    0x8(%ebp),%esi
  pushcli();
80103a9c:	e8 9f 0b 00 00       	call   80104640 <pushcli>
  c = mycpu();
80103aa1:	e8 2a fe ff ff       	call   801038d0 <mycpu>
  p = c->proc;
80103aa6:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103aac:	e8 df 0b 00 00       	call   80104690 <popcli>
  sz = curproc->sz;
...
80103abf:	e8 5c 31 00 00       	call   80106c20 <switchuvm>
  return 0;
...
80103ada:	e8 a1 33 00 00       	call   80106e80 <allocuvm>
...
80103afa:	e8 b1 34 00 00       	call   80106fb0 <deallocuvm>
...
80103b1a:	83 ec 1c             	sub    $0x1c,%esp
  pushcli();
80103b1d:	e8 1e 0b 00 00       	call   80104640 <pushcli>
  c = mycpu();
80103b22:	e8 a9 fd ff ff       	call   801038d0 <mycpu>
  p = c->proc;
80103b27:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103b2d:	e8 5e 0b 00 00       	call   80104690 <popcli>
  if((np = allocproc()) == 0){
...
80103b4c:	e8 df 35 00 00       	call   80107130 <copyuvm>
...
80103c66:	e8 d5 0a 00 00       	call   80104740 <acquire>
...
80103c80:	e8 9b 2f 00 00       	call   80106c20 <switchuvm>
...
80103c8b:	c7 43 0c 04 00 00 00 	movl   $0x4,0xc(%ebx)
      swtch(&(c->scheduler), p->context);
80103c92:	e8 dc 0d 00 00       	call   80104a73 <swtch>
      switchkvm();
80103c97:	e8 64 2f 00 00       	call   80106c00 <switchkvm>
      c->proc = 0;
...
80103cbc:	e8 3f 0b 00 00       	call   80104800 <release>
    sti();
...
80103d37:	e8 37 0d 00 00       	call   80104a73 <swtch>
  mycpu()->intena = intena;
...
80103d9a:	83 ec 0c             	sub    $0xc,%esp
  pushcli();
80103d9d:	e8 9e 08 00 00       	call   80104640 <pushcli>
  c = mycpu();
80103da2:	e8 29 fb ff ff       	call   801038d0 <mycpu>
  p = c->proc;
80103da7:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80103dad:	e8 de 08 00 00       	call   80104690 <popcli>
  if(curproc == initproc)
...
80103e0a:	e8 31 09 00 00       	call   80104740 <acquire>
...
80103ead:	68 c8 78 10 80       	push   $0x801078c8
80103eb2:	e8 d9 c4 ff ff       	call   80100390 <panic>
    panic("init exiting");
80103eb7:	83 ec 0c             	sub    $0xc,%esp
80103eba:	68 bb 78 10 80       	push   $0x801078bb
...
80103ee0:	e8 5b 08 00 00       	call   80104740 <acquire>
  pushcli();
80103ee5:	e8 56 07 00 00       	call   80104640 <pushcli>
  c = mycpu();
80103eea:	e8 e1 f9 ff ff       	call   801038d0 <mycpu>
  p = c->proc;
80103eef:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103ef5:	e8 96 07 00 00       	call   80104690 <popcli>
...
80103f0d:	e8 ee 08 00 00       	call   80104800 <release>
}
...
80103f30:	8b 75 0c             	mov    0xc(%ebp),%esi
  pushcli();
80103f33:	e8 08 07 00 00       	call   80104640 <pushcli>
  c = mycpu();
80103f38:	e8 93 f9 ff ff       	call   801038d0 <mycpu>
  p = c->proc;
80103f3d:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103f43:	e8 48 07 00 00       	call   80104690 <popcli>
  if(p == 0)
...
80103f64:	e8 d7 07 00 00       	call   80104740 <acquire>
    release(lk);
80103f69:	89 34 24             	mov    %esi,(%esp)
80103f6c:	e8 8f 08 00 00       	call   80104800 <release>
  p->chan = chan;
...
80103f8e:	e8 6d 08 00 00       	call   80104800 <release>
    acquire(lk);
...
80103f9f:	5d                   	pop    %ebp
    acquire(lk);
80103fa0:	e9 9b 07 00 00       	jmp    80104740 <acquire>
...
80103fc9:	68 da 78 10 80       	push   $0x801078da
80103fce:	e8 bd c3 ff ff       	call   80100390 <panic>
    panic("sleep");
80103fd3:	83 ec 0c             	sub    $0xc,%esp
80103fd6:	68 d4 78 10 80       	push   $0x801078d4
...
8010407a:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80104081:	e8 5a 2f 00 00       	call   80106fe0 <freevm>
        release(&ptable.lock);
...
801040a6:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
801040ad:	e8 4e 07 00 00       	call   80104800 <release>
        return pid;
...
801040cb:	e8 30 07 00 00       	call   80104800 <release>
      return -1;
...
801040f3:	e8 48 06 00 00       	call   80104740 <acquire>
...
80104138:	c9                   	leave  
  release(&ptable.lock);
80104139:	e9 c2 06 00 00       	jmp    80104800 <release>
...
80104153:	e8 e8 05 00 00       	call   80104740 <acquire>
...
80104193:	e8 68 06 00 00       	call   80104800 <release>
      return 0;
    }
  }
  release(&ptable.lock);
...
801041b0:	e8 4b 06 00 00       	call   80104800 <release>
}
...
801041f3:	68 6b 7e 10 80       	push   $0x80107e6b
...
80104214:	74 ea                	je     80104200 <procdump+0x30>
      state = "???";
80104216:	ba eb 78 10 80       	mov    $0x801078eb,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
8010421b:	83 f8 05             	cmp    $0x5,%eax
8010421e:	77 11                	ja     80104231 <procdump+0x61>
80104220:	8b 14 85 f8 7a 10 80 	mov    -0x7fef8508(,%eax,4),%edx
      state = "???";
80104227:	b8 eb 78 10 80       	mov    $0x801078eb,%eax
...
80104236:	68 ef 78 10 80       	push   $0x801078ef
...
8010425d:	e8 7e 03 00 00       	call   801045e0 <getcallerpcs>
      for(i=0; i<10 && pc[i] != 0; i++)
...
80104275:	68 41 73 10 80       	push   $0x80107341
...
801042ba:	e8 81 04 00 00       	call   80104740 <acquire>
  cprintf("\n\tNAME\t\t|\tPID\t|\tSTATE\t\t|\tSIZE\t|\tPARENT\t\n");
801042bf:	c7 04 24 64 79 10 80 	movl   $0x80107964,(%esp)
...
801042d3:	81 fb 54 4c 11 80    	cmp    $0x80114c54,%ebx
...
801042e5:	68 90 79 10 80       	push   $0x80107990
...
80104335:	68 7c 7a 10 80       	push   $0x80107a7c
8010433a:	e8 71 c3 ff ff       	call   801006b0 <cprintf>
8010433f:	83 c4 20             	add    $0x20,%esp
  for (process = ptable.proc; process < &ptable.proc[NPROC]; process++)
80104342:	81 fb 54 4c 11 80    	cmp    $0x80114c54,%ebx
...
8010438a:	68 9c 7a 10 80       	push   $0x80107a9c
8010438f:	e8 1c c3 ff ff       	call   801006b0 <cprintf>
      release(&ptable.lock);
80104394:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
...
801043c3:	68 f0 79 10 80       	push   $0x801079f0
...
801043eb:	68 10 7a 10 80       	push   $0x80107a10
...
80104413:	68 34 7a 10 80       	push   $0x80107a34
...
8010443b:	68 58 7a 10 80       	push   $0x80107a58
...
80104451:	68 d0 7a 10 80       	push   $0x80107ad0
80104456:	e8 55 c2 ff ff       	call   801006b0 <cprintf>
  release(&ptable.lock);
8010445b:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80104462:	e8 99 03 00 00       	call   80104800 <release>
  return 42;
...
8010448e:	68 10 7b 10 80       	push   $0x80107b10
...
801044ed:	e8 2e fa ff ff       	call   80103f20 <sleep>
  while (lk->locked) {
...
801044fb:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
80104501:	e8 5a f4 ff ff       	call   80103960 <myproc>
...
80104548:	e8 93 fb ff ff       	call   801040e0 <wakeup>
  release(&lk->lk);
...
801045a3:	e8 b8 f3 ff ff       	call   80103960 <myproc>
...
8010466f:	90                   	nop
    mycpu()->intena = eflags & FL_IF;
80104670:	e8 5b f2 ff ff       	call   801038d0 <mycpu>
...
801046bf:	c3                   	ret    
  if(mycpu()->ncli == 0 && mycpu()->intena)
801046c0:	e8 0b f2 ff ff       	call   801038d0 <mycpu>
...
801046d5:	68 1b 7b 10 80       	push   $0x80107b1b
801046da:	e8 b1 bc ff ff       	call   80100390 <panic>
    panic("popcli");
801046df:	83 ec 0c             	sub    $0xc,%esp
801046e2:	68 32 7b 10 80       	push   $0x80107b32
...
8010471b:	e8 b0 f1 ff ff       	call   801038d0 <mycpu>
...
80104784:	e8 47 f1 ff ff       	call   801038d0 <mycpu>
...
801047e7:	68 39 7b 10 80       	push   $0x80107b39
...
80104840:	68 41 7b 10 80       	push   $0x80107b41
...
80104a9b:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *curproc = myproc();
80104a9e:	e8 bd ee ff ff       	call   80103960 <myproc>
...
80104b39:	e8 22 ee ff ff       	call   80103960 <myproc>
...
80104b47:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104b4a:	e8 11 ee ff ff       	call   80103960 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
...
80104b8c:	8b 5d 10             	mov    0x10(%ebp),%ebx
  int i;
  struct proc *curproc = myproc();
80104b8f:	e8 cc ed ff ff       	call   80103960 <myproc>
...
80104c3b:	83 fa 29             	cmp    $0x29,%edx
80104c3e:	77 20                	ja     80104c60 <syscall+0x40>
80104c40:	8b 14 85 80 7b 10 80 	mov    -0x7fef8480(,%eax,4),%edx
...
80104c68:	68 49 7b 10 80       	push   $0x80107b49
...
80104dc4:	68 48 7c 10 80       	push   $0x80107c48
...
80104ddc:	68 47 7c 10 80       	push   $0x80107c47
...
80104df1:	68 3b 7c 10 80       	push   $0x80107c3b
...
80104e0f:	68 4a 7c 10 80       	push   $0x80107c4a
80104e14:	e8 77 b5 ff ff       	call   80100390 <panic>
    panic("create: ialloc");
80104e19:	83 ec 0c             	sub    $0xc,%esp
80104e1c:	68 2c 7c 10 80       	push   $0x80107c2c
...
80104e54:	e8 07 eb ff ff       	call   80103960 <myproc>
...
80104e9d:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
80104e9f:	e8 bc ea ff ff       	call   80103960 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80104fe7:	78 27                	js     80105010 <sys_close+0x40>
  myproc()->ofile[fd] = 0;
80104fe9:	e8 72 e9 ff ff       	call   80103960 <myproc>
...
8010520d:	58                   	pop    %eax
8010520e:	5a                   	pop    %edx
8010520f:	68 48 7c 10 80       	push   $0x80107c48
...
80105228:	68 47 7c 10 80       	push   $0x80107c47
...
80105417:	74 23                	je     8010543c <sys_open+0x9c>
  struct proc *curproc = myproc();
80105419:	e8 42 e5 ff ff       	call   80103960 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
801055f9:	83 ec 10             	sub    $0x10,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
801055fc:	e8 5f e3 ff ff       	call   80103960 <myproc>
...
80105827:	8b 7d e4             	mov    -0x1c(%ebp),%edi
  struct proc *curproc = myproc();
8010582a:	e8 31 e1 ff ff       	call   80103960 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80105846:	75 f0                	jne    80105838 <sys_pipe+0x98>
      myproc()->ofile[fd0] = 0;
80105848:	e8 13 e1 ff ff       	call   80103960 <myproc>
...
80105880:	f3 0f 1e fb          	endbr32 
  return fork();
80105884:	e9 87 e2 ff ff       	jmp    80103b10 <fork>
...
80105897:	83 ec 08             	sub    $0x8,%esp
  exit();
8010589a:	e8 f1 e4 ff ff       	call   80103d90 <exit>
...
801058b0:	f3 0f 1e fb          	endbr32 
  return wait();
801058b4:	e9 27 e7 ff ff       	jmp    80103fe0 <wait>
...
801058e2:	e8 59 e8 ff ff       	call   80104140 <kill>
...
8010593b:	78 23                	js     80105960 <sys_sbrk+0x40>
    return -1;
  addr = myproc()->sz;
8010593d:	e8 1e e0 ff ff       	call   80103960 <myproc>
  if(growproc(n) < 0)
...
8010594a:	e8 41 e1 ff ff       	call   80103a90 <growproc>
...
801059bd:	e8 5e e5 ff ff       	call   80103f20 <sleep>
  while(ticks - ticks0 < n){
...
801059cf:	73 2f                	jae    80105a00 <sys_sleep+0x90>
    if(myproc()->killed){
801059d1:	e8 8a df ff ff       	call   80103960 <myproc>
...
80105a60:	e8 cb f0 ff ff       	call   80104b30 <argint>
80105a65:	83 c4 10             	add    $0x10,%esp
80105a68:	85 c0                	test   %eax,%eax
80105a6a:	78 14                	js     80105a80 <sys_faps+0x30>
    return -1;

  return faps(pid);
80105a6c:	83 ec 0c             	sub    $0xc,%esp
80105a6f:	ff 75 f4             	pushl  -0xc(%ebp)
80105a72:	e8 29 e8 ff ff       	call   801042a0 <faps>
...
80105ac7:	c7 04 c5 a2 4c 11 80 	movl   $0x8e000008,-0x7feeb35e(,%eax,8)
80105ace:	08 00 00 8e 
80105ad2:	66 89 14 c5 a0 4c 11 	mov    %dx,-0x7feeb360(,%eax,8)
80105ad9:	80 
80105ada:	c1 ea 10             	shr    $0x10,%edx
80105add:	66 89 14 c5 a6 4c 11 	mov    %dx,-0x7feeb35a(,%eax,8)
80105ae4:	80 
  for(i = 0; i < 256; i++)
...
80105aef:	83 ec 08             	sub    $0x8,%esp
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105af2:	a1 08 a1 10 80       	mov    0x8010a108,%eax
80105af7:	c7 05 a2 4e 11 80 08 	movl   $0xef000008,0x80114ea2
80105afe:	00 00 ef 
  initlock(&tickslock, "time");
80105b01:	68 8d 7c 10 80       	push   $0x80107c8d
80105b06:	68 60 4c 11 80       	push   $0x80114c60
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105b0b:	66 a3 a0 4e 11 80    	mov    %ax,0x80114ea0
80105b11:	c1 e8 10             	shr    $0x10,%eax
80105b14:	66 a3 a6 4e 11 80    	mov    %ax,0x80114ea6
  initlock(&tickslock, "time");
80105b1a:	e8 a1 ea ff ff       	call   801045c0 <initlock>
}
...
80105b34:	55                   	push   %ebp
  pd[0] = size-1;
80105b35:	b8 ff 07 00 00       	mov    $0x7ff,%eax
80105b3a:	89 e5                	mov    %esp,%ebp
80105b3c:	83 ec 10             	sub    $0x10,%esp
80105b3f:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80105b43:	b8 a0 4c 11 80       	mov    $0x80114ca0,%eax
80105b48:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  pd[2] = (uint)p >> 16;
80105b4c:	c1 e8 10             	shr    $0x10,%eax
80105b4f:	66 89 45 fe          	mov    %ax,-0x2(%ebp)
  asm volatile("lidt (%0)" : : "r" (pd));
80105b53:	8d 45 fa             	lea    -0x6(%ebp),%eax
80105b56:	0f 01 18             	lidtl  (%eax)
  lidt(idt, sizeof(idt));
}
80105b59:	c9                   	leave  
80105b5a:	c3                   	ret    
...
80105b6d:	8b 5d 08             	mov    0x8(%ebp),%ebx
  if(tf->trapno == T_SYSCALL){
80105b70:	8b 43 30             	mov    0x30(%ebx),%eax
80105b73:	83 f8 40             	cmp    $0x40,%eax
80105b76:	0f 84 bc 01 00 00    	je     80105d38 <trap+0x1d8>
    if(myproc()->killed)
      exit();
    return;
  }
  ...
  switch(tf->trapno){
80105b7c:	83 e8 20             	sub    $0x20,%eax
80105b7f:	83 f8 1f             	cmp    $0x1f,%eax
80105b82:	77 08                	ja     80105b8c <trap+0x2c>
80105b84:	3e ff 24 85 34 7d 10 	notrack jmp *-0x7fef82cc(,%eax,4)
80105b8b:	80 
    lapiceoi();
    break;
...
80105b8c:	e8 cf dd ff ff       	call   80103960 <myproc>
80105b91:	8b 7b 38             	mov    0x38(%ebx),%edi
80105b94:	85 c0                	test   %eax,%eax
80105b96:	0f 84 eb 01 00 00    	je     80105d87 <trap+0x227>
80105b9c:	f6 43 3c 03          	testb  $0x3,0x3c(%ebx)
80105ba0:	0f 84 e1 01 00 00    	je     80105d87 <trap+0x227>
...
80105ba6:	0f 20 d1             	mov    %cr2,%ecx
80105ba9:	89 4d d8             	mov    %ecx,-0x28(%ebp)
...
80105bac:	e8 8f dd ff ff       	call   80103940 <cpuid>
80105bb1:	8b 73 30             	mov    0x30(%ebx),%esi
80105bb4:	89 45 dc             	mov    %eax,-0x24(%ebp)
80105bb7:	8b 43 34             	mov    0x34(%ebx),%eax
80105bba:	89 45 e4             	mov    %eax,-0x1c(%ebp)
            "eip 0x%x addr 0x%x--kill proc\n",
            myproc()->pid, myproc()->name, tf->trapno,
80105bbd:	e8 9e dd ff ff       	call   80103960 <myproc>
80105bc2:	89 45 e0             	mov    %eax,-0x20(%ebp)
80105bc5:	e8 96 dd ff ff       	call   80103960 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80105bca:	8b 4d d8             	mov    -0x28(%ebp),%ecx
80105bcd:	8b 55 dc             	mov    -0x24(%ebp),%edx
80105bd0:	51                   	push   %ecx
80105bd1:	57                   	push   %edi
80105bd2:	52                   	push   %edx
80105bd3:	ff 75 e4             	pushl  -0x1c(%ebp)
80105bd6:	56                   	push   %esi
            myproc()->pid, myproc()->name, tf->trapno,
80105bd7:	8b 75 e0             	mov    -0x20(%ebp),%esi
80105bda:	83 c6 6c             	add    $0x6c,%esi
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80105bdd:	56                   	push   %esi
80105bde:	ff 70 10             	pushl  0x10(%eax)
80105be1:	68 f0 7c 10 80       	push   $0x80107cf0
80105be6:	e8 c5 aa ff ff       	call   801006b0 <cprintf>
            tf->err, cpuid(), tf->eip, rcr2());
    myproc()->killed = 1;
80105beb:	83 c4 20             	add    $0x20,%esp
80105bee:	e8 6d dd ff ff       	call   80103960 <myproc>
80105bf3:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
  }
...
80105bfa:	e8 61 dd ff ff       	call   80103960 <myproc>
80105bff:	85 c0                	test   %eax,%eax
80105c01:	74 1d                	je     80105c20 <trap+0xc0>
80105c03:	e8 58 dd ff ff       	call   80103960 <myproc>
80105c08:	8b 50 24             	mov    0x24(%eax),%edx
80105c0b:	85 d2                	test   %edx,%edx
80105c0d:	74 11                	je     80105c20 <trap+0xc0>
80105c0f:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
80105c13:	83 e0 03             	and    $0x3,%eax
80105c16:	66 83 f8 03          	cmp    $0x3,%ax
80105c1a:	0f 84 50 01 00 00    	je     80105d70 <trap+0x210>
    exit();

  // Force process to give up CPU on clock tick.
  // If interrupts were on while locks held, would need to check nlock.
  if(myproc() && myproc()->state == RUNNING &&
80105c20:	e8 3b dd ff ff       	call   80103960 <myproc>
80105c25:	85 c0                	test   %eax,%eax
80105c27:	74 0f                	je     80105c38 <trap+0xd8>
80105c29:	e8 32 dd ff ff       	call   80103960 <myproc>
80105c2e:	83 78 0c 04          	cmpl   $0x4,0xc(%eax)
80105c32:	0f 84 e8 00 00 00    	je     80105d20 <trap+0x1c0>
     tf->trapno == T_IRQ0+IRQ_TIMER)
    yield();

  // Check if the process has been killed since we yielded
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105c38:	e8 23 dd ff ff       	call   80103960 <myproc>
80105c3d:	85 c0                	test   %eax,%eax
80105c3f:	74 1d                	je     80105c5e <trap+0xfe>
80105c41:	e8 1a dd ff ff       	call   80103960 <myproc>
80105c46:	8b 40 24             	mov    0x24(%eax),%eax
80105c49:	85 c0                	test   %eax,%eax
80105c4b:	74 11                	je     80105c5e <trap+0xfe>
80105c4d:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
80105c51:	83 e0 03             	and    $0x3,%eax
80105c54:	66 83 f8 03          	cmp    $0x3,%ax
80105c58:	0f 84 03 01 00 00    	je     80105d61 <trap+0x201>
    exit();
}
...
80105c65:	c3                   	ret    
    ideintr();
80105c66:	e8 75 c5 ff ff       	call   801021e0 <ideintr>
    lapiceoi();
80105c6b:	e8 50 cc ff ff       	call   801028c0 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105c70:	e8 eb dc ff ff       	call   80103960 <myproc>
80105c75:	85 c0                	test   %eax,%eax
80105c77:	75 8a                	jne    80105c03 <trap+0xa3>
80105c79:	eb a5                	jmp    80105c20 <trap+0xc0>
    if(cpuid() == 0){
80105c7b:	e8 c0 dc ff ff       	call   80103940 <cpuid>
80105c80:	85 c0                	test   %eax,%eax
80105c82:	75 e7                	jne    80105c6b <trap+0x10b>
      acquire(&tickslock);
80105c84:	83 ec 0c             	sub    $0xc,%esp
80105c87:	68 60 4c 11 80       	push   $0x80114c60
80105c8c:	e8 af ea ff ff       	call   80104740 <acquire>
      wakeup(&ticks);
80105c91:	c7 04 24 a0 54 11 80 	movl   $0x801154a0,(%esp)
      ticks++;
80105c98:	83 05 a0 54 11 80 01 	addl   $0x1,0x801154a0
      wakeup(&ticks);
80105c9f:	e8 3c e4 ff ff       	call   801040e0 <wakeup>
      release(&tickslock);
80105ca4:	c7 04 24 60 4c 11 80 	movl   $0x80114c60,(%esp)
80105cab:	e8 50 eb ff ff       	call   80104800 <release>
80105cb0:	83 c4 10             	add    $0x10,%esp
    lapiceoi();
80105cb3:	eb b6                	jmp    80105c6b <trap+0x10b>
    kbdintr();
80105cb5:	e8 c6 ca ff ff       	call   80102780 <kbdintr>
    lapiceoi();
80105cba:	e8 01 cc ff ff       	call   801028c0 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105cbf:	e8 9c dc ff ff       	call   80103960 <myproc>
80105cc4:	85 c0                	test   %eax,%eax
80105cc6:	0f 85 37 ff ff ff    	jne    80105c03 <trap+0xa3>
80105ccc:	e9 4f ff ff ff       	jmp    80105c20 <trap+0xc0>
    uartintr();
80105cd1:	e8 4a 02 00 00       	call   80105f20 <uartintr>
    lapiceoi();
80105cd6:	e8 e5 cb ff ff       	call   801028c0 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105cdb:	e8 80 dc ff ff       	call   80103960 <myproc>
80105ce0:	85 c0                	test   %eax,%eax
80105ce2:	0f 85 1b ff ff ff    	jne    80105c03 <trap+0xa3>
80105ce8:	e9 33 ff ff ff       	jmp    80105c20 <trap+0xc0>
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80105ced:	8b 7b 38             	mov    0x38(%ebx),%edi
80105cf0:	0f b7 73 3c          	movzwl 0x3c(%ebx),%esi
80105cf4:	e8 47 dc ff ff       	call   80103940 <cpuid>
80105cf9:	57                   	push   %edi
80105cfa:	56                   	push   %esi
80105cfb:	50                   	push   %eax
80105cfc:	68 98 7c 10 80       	push   $0x80107c98
...
80105d15:	0f 85 e8 fe ff ff    	jne    80105c03 <trap+0xa3>
80105d1b:	e9 00 ff ff ff       	jmp    80105c20 <trap+0xc0>
  if(myproc() && myproc()->state == RUNNING &&
80105d20:	83 7b 30 20          	cmpl   $0x20,0x30(%ebx)
80105d24:	0f 85 0e ff ff ff    	jne    80105c38 <trap+0xd8>
    yield();
80105d2a:	e8 a1 e1 ff ff       	call   80103ed0 <yield>
80105d2f:	e9 04 ff ff ff       	jmp    80105c38 <trap+0xd8>
80105d34:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if(myproc()->killed)
80105d38:	e8 23 dc ff ff       	call   80103960 <myproc>
80105d3d:	8b 70 24             	mov    0x24(%eax),%esi
80105d40:	85 f6                	test   %esi,%esi
80105d42:	75 3c                	jne    80105d80 <trap+0x220>
    myproc()->tf = tf;
80105d44:	e8 17 dc ff ff       	call   80103960 <myproc>
80105d49:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80105d4c:	e8 cf ee ff ff       	call   80104c20 <syscall>
    if(myproc()->killed)
80105d51:	e8 0a dc ff ff       	call   80103960 <myproc>
80105d56:	8b 48 24             	mov    0x24(%eax),%ecx
80105d59:	85 c9                	test   %ecx,%ecx
80105d5b:	0f 84 fd fe ff ff    	je     80105c5e <trap+0xfe>
}
...
80105d67:	5d                   	pop    %ebp
      exit();
80105d68:	e9 23 e0 ff ff       	jmp    80103d90 <exit>
80105d6d:	8d 76 00             	lea    0x0(%esi),%esi
    exit();
80105d70:	e8 1b e0 ff ff       	call   80103d90 <exit>
80105d75:	e9 a6 fe ff ff       	jmp    80105c20 <trap+0xc0>
80105d7a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      exit();
80105d80:	e8 0b e0 ff ff       	call   80103d90 <exit>
80105d85:	eb bd                	jmp    80105d44 <trap+0x1e4>
80105d87:	0f 20 d6             	mov    %cr2,%esi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80105d8a:	e8 b1 db ff ff       	call   80103940 <cpuid>
...
80105d98:	68 bc 7c 10 80       	push   $0x80107cbc
80105d9d:	e8 0e a9 ff ff       	call   801006b0 <cprintf>
      panic("trap");
80105da2:	83 c4 14             	add    $0x14,%esp
80105da5:	68 92 7c 10 80       	push   $0x80107c92
...
80105ea3:	be 76 00 00 00       	mov    $0x76,%esi
  for(p="xv6...\n"; *p; p++)
80105ea8:	bb b4 7d 10 80       	mov    $0x80107db4,%ebx
  ioapicenable(IRQ_COM1, 0);
...
80105f61:	e9 21 fb ff ff       	jmp    80105a87 <alltraps>

80105f66 <vector5>:
80105f66:	6a 00                	push   $0x0
80105f68:	6a 05                	push   $0x5
80105f6a:	e9 18 fb ff ff       	jmp    80105a87 <alltraps>

80105f6f <vector6>:
80105f6f:	6a 00                	push   $0x0
80105f71:	6a 06                	push   $0x6
80105f73:	e9 0f fb ff ff       	jmp    80105a87 <alltraps>

80105f78 <vector7>:
80105f78:	6a 00                	push   $0x0
80105f7a:	6a 07                	push   $0x7
80105f7c:	e9 06 fb ff ff       	jmp    80105a87 <alltraps>

80105f81 <vector8>:
80105f81:	6a 08                	push   $0x8
80105f83:	e9 ff fa ff ff       	jmp    80105a87 <alltraps>

80105f88 <vector9>:
80105f88:	6a 00                	push   $0x0
80105f8a:	6a 09                	push   $0x9
80105f8c:	e9 f6 fa ff ff       	jmp    80105a87 <alltraps>

80105f91 <vector10>:
80105f91:	6a 0a                	push   $0xa
80105f93:	e9 ef fa ff ff       	jmp    80105a87 <alltraps>

80105f98 <vector11>:
80105f98:	6a 0b                	push   $0xb
80105f9a:	e9 e8 fa ff ff       	jmp    80105a87 <alltraps>

80105f9f <vector12>:
80105f9f:	6a 0c                	push   $0xc
80105fa1:	e9 e1 fa ff ff       	jmp    80105a87 <alltraps>
...
80105fc1:	e9 c1 fa ff ff       	jmp    80105a87 <alltraps>
...
8010638b:	e9 f7 f6 ff ff       	jmp    80105a87 <alltraps>

80106390 <vector125>:
80106390:	6a 00                	push   $0x0
80106392:	6a 7d                	push   $0x7d
80106394:	e9 ee f6 ff ff       	jmp    80105a87 <alltraps>

80106399 <vector126>:
80106399:	6a 00                	push   $0x0
8010639b:	6a 7e                	push   $0x7e
8010639d:	e9 e5 f6 ff ff       	jmp    80105a87 <alltraps>
...
8010698e:	e9 f4 f0 ff ff       	jmp    80105a87 <alltraps>

80106993 <vector254>:
80106993:	6a 00                	push   $0x0
80106995:	68 fe 00 00 00       	push   $0xfe
8010699a:	e9 e8 f0 ff ff       	jmp    80105a87 <alltraps>

8010699f <vector255>:
8010699f:	6a 00                	push   $0x0
801069a1:	68 ff 00 00 00       	push   $0xff
801069a6:	e9 dc f0 ff ff       	jmp    80105a87 <alltraps>
...
80106a0a:	e8 41 de ff ff       	call   80104850 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
80106aad:	68 bc 7d 10 80       	push   $0x80107dbc
...
80106b77:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
80106b7a:	e8 c1 cd ff ff       	call   80103940 <cpuid>
  pd[0] = size-1;
...
80106c04:	a1 a4 54 11 80       	mov    0x801154a4,%eax
...
80106c48:	0f 84 c2 00 00 00    	je     80106d10 <switchuvm+0xf0>
  pushcli();
80106c4e:	e8 ed d9 ff ff       	call   80104640 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80106c53:	e8 78 cc ff ff       	call   801038d0 <mycpu>
80106c58:	89 c3                	mov    %eax,%ebx
80106c5a:	e8 71 cc ff ff       	call   801038d0 <mycpu>
80106c5f:	89 c7                	mov    %eax,%edi
80106c61:	e8 6a cc ff ff       	call   801038d0 <mycpu>
80106c66:	83 c7 08             	add    $0x8,%edi
80106c69:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106c6c:	e8 5f cc ff ff       	call   801038d0 <mycpu>
...
80106d63:	e8 e8 da ff ff       	call   80104850 <memset>
...
80106d96:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106d97:	e9 54 db ff ff       	jmp    801048f0 <memmove>
    panic("inituvm: more than a page");
80106d9c:	83 ec 0c             	sub    $0xc,%esp
80106d9f:	68 01 7e 10 80       	push   $0x80107e01
...
80106ecb:	e8 80 d9 ff ff       	call   80104850 <memset>
...
80106f09:	68 39 7e 10 80       	push   $0x80107e39
...
80106f6b:	68 51 7e 10 80       	push   $0x80107e51
...
8010704c:	68 6d 7e 10 80       	push   $0x80107e6d
...
80107084:	e8 c7 d7 ff ff       	call   80104850 <memset>
...
801070ef:	a3 a4 54 11 80       	mov    %eax,0x801154a4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
80107123:	68 7e 7e 10 80       	push   $0x80107e7e
...
80107209:	68 a2 7e 10 80       	push   $0x80107ea2
8010720e:	e8 7d 91 ff ff       	call   80100390 <panic>
      panic("copyuvm: pte should exist");
80107213:	83 ec 0c             	sub    $0xc,%esp
80107216:	68 88 7e 10 80       	push   $0x80107e88
...
8010729e:	e8 4d d6 ff ff       	call   801048f0 <memmove>
    len -= n;
    buf += n;
